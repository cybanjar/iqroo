    ...
    <b-row>
      ...
      <b-col
        ...
        <b-img
          width="170"
          fluid
          src="~assets/image/bismillah.png"/>
      </b-col>
      <b-col
        cols="auto"
        class="p-3">
        ...
        <b-card
          ...
          <b-row
            ...
            <b-col
              ...
              lg="2"
              xl="2"
              class="number">{{ item.number.inSurah }}/{{ total }}</b-col>
            <b-col
              cols="12"
              sm="9"
              md="9"
              lg="9"
              xl="9"
              class="text-right text-arab">{{ item.text.arab }}</b-col>
          </b-row>
          <p class="text-grey">{{ item.translation.id }}</p>
          <b-button
            class="no-padding mb-2"
            variant="link"
            @click="showTafsir(item)">Tafsir</b-button>
          <div>
            <audio controls>
              <source
